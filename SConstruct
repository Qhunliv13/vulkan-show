...
sources = [
    'main.cpp',
    'renderer/core/application.cpp',
    'renderer/core/app_initializer.cpp',
    'renderer/core/config_manager.cpp',
    'renderer/core/window_manager.cpp',
    'renderer/core/input_handler.cpp',
    'renderer/core/ui_manager.cpp',
    'renderer/core/ui_manager_getters.cpp',
    'renderer/core/event_manager.cpp',
    'renderer/core/scene_manager.cpp',
    'renderer/core/render_scheduler.cpp',
    'renderer/core/window_message_handler.cpp',
    'renderer/core/fps_monitor.cpp',
    'renderer/core/logger.cpp',
    'renderer/core/event_bus.cpp',
    'renderer/core/button_ui_manager.cpp',
    'renderer/core/color_ui_manager.cpp',
    'renderer/core/slider_ui_manager.cpp',
